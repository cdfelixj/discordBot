...
public class MyFirstBot {
    private static final String token = "discord bot api token";
    ...
    public static void main(String[] args) {
        ...
        textBot.addListener(new CoinBot()); //Added a coin bot to flip a coin

        AbstractBot[] bots = new AbstractBot[]{
                textBot, umBot, new ScoreBot(umBot), new WhoAmIBot(umBot) , new CurrencyBot() //added currency Bot
        };
